...
API_ID = int(environ.get('API_ID', '28269435'))  # Telegram API ID
API_HASH = environ.get('API_HASH', '839f282133fe8ee79b4a946095cf4360')  # Telegram API Hash
BOT_TOKEN = environ.get('BOT_TOKEN', '')  # Telegram Bot Token

# 👑, Channels & Logs
BIN_CHANNEL = int(environ.get("BIN_CHANNEL", '-1002818182996'))  # File storage channel
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", '-1002691497570'))  # General log channel
PREMIUM_LOGS = int(environ.get("PREMIUM_LOGS", '-1002691497570'))  # Premium user actions log
VERIFIED_LOG = int(environ.get('VERIFIED_LOG', '-1002691497570'))  # Verified user actions log
...
ADMINS = list(map(int, environ.get('ADMINS', '8005648537').split()))  # List of admin user IDs
AUTH_CHANNEL = list(map(int, environ.get("AUTH_CHANNEL", "-1002647662043 -1002611366051").split()))  # Allowed channels for authorization

# username add without @
OWNER_USERNAME = environ.get("OWNER_USERNAME", 'Mr_HP_Raj')  # Owner's username
BOT_USERNAME = environ.get("BOT_USERNAME", 'HP_RajStream_Bot')  # Bot's username

# 🔗 Channel & Support Links
CHANNEL = environ.get('CHANNEL', 'https://t.me/+DdA9O8bwZ0ljODk1')  # Updates channel
SUPPORT = environ.get('SUPPORT', 'https://t.me/+fzXLS_LbzSFjOTVl')  # Support group
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/Howtoopenlink271/41')  # Verification guide link
HOW_TO_OPEN = environ.get('HOW_TO_OPEN', 'https://t.me/Howtoopenlink271/41')  # File access guide link
...
DB_URL = environ.get('DATABASE_URI', "mongodb+srv://Hanuman:hanuman@cluster0.l5toshc.mongodb.net/?retryWrites=true&w=majority")  # MongoDB connection URI
DB_NAME = environ.get('DATABASE_NAME', "Hanuman")  # MongoDB database name
...
PICS = environ.get('PICS', 'https://graph.org/file/819dd1a293d5fea054e07-d509d6c5c97bab7fe9.jpg')  # Default info image
...
FQDN = getenv("FQDN", "https://av-file-to-link-pro-90r1.onrender.com") or BIND_ADDRESS  # Full domain name or fallback to bind address
